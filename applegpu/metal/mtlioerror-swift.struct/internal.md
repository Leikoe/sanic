...
<https://developer.apple.com/documentation/metal/mtlioerror-swift.struct/internal>
...
```swift
static var `internal`: MTLIOError.Code { get }
```

## See also

### Error codes
- [urlInvalid](https://developer.apple.com/documentation/metal/mtlioerror-swift.struct/urlinvalid) — An error that represents a problem with a file URL.
