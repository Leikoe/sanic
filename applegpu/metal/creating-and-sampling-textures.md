...
Use an [MTLTextureDescriptor](https://developer.apple.com/documentation/metal/mtltexturedescriptor) object to configure properties like texture dimensions and pixel format for an [MTLTexture](https://developer.apple.com/documentation/metal/mtltexture) object. Then call the [makeTexture(descriptor:)](https://developer.apple.com/documentation/metal/mtldevice/maketexture(descriptor:)) method to create a texture.
...
Call the [replace(region:mipmapLevel:withBytes:bytesPerRow:)](https://developer.apple.com/documentation/metal/mtltexture/replace(region:mipmaplevel:withbytes:bytesperrow:)) method on the texture to copy pixel data from the `AAPLImage` object into the texture.
...
![image](https://docs-assets.developer.apple.com/published/a0dac218926802ccbb16373b9fb7c978/2-MetalTextureCoordinates.png)
