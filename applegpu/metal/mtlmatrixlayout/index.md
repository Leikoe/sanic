...
*Enumeration · iOS 18.0, iPadOS 18.0, Mac Catalyst 18.0, macOS 15.0, tvOS 18.1, visionOS 2.1*
...
### Enumeration Cases
- [MTLMatrixLayout.columnMajor](https://developer.apple.com/documentation/metal/mtlmatrixlayout/columnmajor)
- [MTLMatrixLayout.rowMajor](https://developer.apple.com/documentation/metal/mtlmatrixlayout/rowmajor)

### Initializers
- [init(rawValue:)](https://developer.apple.com/documentation/metal/mtlmatrixlayout/init(rawvalue:))
