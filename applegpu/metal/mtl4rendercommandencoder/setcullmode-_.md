...
<https://developer.apple.com/documentation/metal/mtl4rendercommandencoder/setcullmode(_:)>
...
- **cullMode** — [MTLCullMode](https://developer.apple.com/documentation/metal/mtlcullmode) to set.
