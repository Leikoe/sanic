...
<https://developer.apple.com/documentation/metal/mtlarchitecture/name>
...
Apps can use this property’s value to make decisions at runtime. For example, an app could retrieve a GPU-specific file from its developer’s content delivery network (CDN), such as a shader library or binary archive. See [Shader libraries](https://developer.apple.com/documentation/metal/shader-libraries) and [Shader library and archive creation](https://developer.apple.com/documentation/metal/shader-library-and-archive-creation) for more information.
