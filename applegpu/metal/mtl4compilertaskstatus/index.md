...
<https://developer.apple.com/documentation/metal/mtl4compilertaskstatus>
...
### Enumeration Cases
- [MTL4CompilerTaskStatus.compiling](https://developer.apple.com/documentation/metal/mtl4compilertaskstatus/compiling) — The compiler task is currently compiling.
- [MTL4CompilerTaskStatus.finished](https://developer.apple.com/documentation/metal/mtl4compilertaskstatus/finished) — The compiler task is finished.
- [MTL4CompilerTaskStatus.none](https://developer.apple.com/documentation/metal/mtl4compilertaskstatus/none) — No status.
- [MTL4CompilerTaskStatus.scheduled](https://developer.apple.com/documentation/metal/mtl4compilertaskstatus/scheduled) — The compiler task is currently scheduled.

### Initializers
- [init(rawValue:)](https://developer.apple.com/documentation/metal/mtl4compilertaskstatus/init(rawvalue:))
