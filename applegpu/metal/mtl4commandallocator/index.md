...
<https://developer.apple.com/documentation/metal/mtl4commandallocator>
...
### Instance Properties
- [device](https://developer.apple.com/documentation/metal/mtl4commandallocator/device) — Returns the GPU device that this command allocator belongs to.
- [label](https://developer.apple.com/documentation/metal/mtl4commandallocator/label) — Provides the optional label you specify at creation time for debug purposes.

### Instance Methods
- [allocatedSize()](https://developer.apple.com/documentation/metal/mtl4commandallocator/allocatedsize()) — Queries the size of the internal memory heaps of this command allocator that support encoding commands into command buffers.
- [reset()](https://developer.apple.com/documentation/metal/mtl4commandallocator/reset()) — Marks the command allocator’s heaps for reuse.
