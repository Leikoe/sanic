...
<https://developer.apple.com/documentation/metal/mtl4compilerdescriptor>
...
### Instance Properties
- [label](https://developer.apple.com/documentation/metal/mtl4compilerdescriptor/label) — Assigns an optional descriptor label to the compiler for debugging purposes.
- [pipelineDataSetSerializer](https://developer.apple.com/documentation/metal/mtl4compilerdescriptor/pipelinedatasetserializer) — Assigns a pipeline data set serializer into which this compiler stores data for all pipelines it creates.
