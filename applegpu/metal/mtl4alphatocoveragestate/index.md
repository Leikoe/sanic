...
<https://developer.apple.com/documentation/metal/mtl4alphatocoveragestate>
...
### Enumeration Cases
- [MTL4AlphaToCoverageState.disabled](https://developer.apple.com/documentation/metal/mtl4alphatocoveragestate/disabled) — Disables alpha-to-coverage.
- [MTL4AlphaToCoverageState.enabled](https://developer.apple.com/documentation/metal/mtl4alphatocoveragestate/enabled) — Enables alpha-to-coverage.

### Initializers
- [init(rawValue:)](https://developer.apple.com/documentation/metal/mtl4alphatocoveragestate/init(rawvalue:))
