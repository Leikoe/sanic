...
<https://developer.apple.com/documentation/metal/mtlcullmode>
...
### Cull modes
- [MTLCullMode.none](https://developer.apple.com/documentation/metal/mtlcullmode/none) — Does not cull any primitives.
- [MTLCullMode.front](https://developer.apple.com/documentation/metal/mtlcullmode/front) — Culls front-facing primitives.
- [MTLCullMode.back](https://developer.apple.com/documentation/metal/mtlcullmode/back) — Culls back-facing primitives.

### Initializers
- [init(rawValue:)](https://developer.apple.com/documentation/metal/mtlcullmode/init(rawvalue:))
