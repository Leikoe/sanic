...
<https://developer.apple.com/documentation/metal/mtl4alphatoonestate>
...
### Enumeration Cases
- [MTL4AlphaToOneState.disabled](https://developer.apple.com/documentation/metal/mtl4alphatoonestate/disabled) — Disables alpha-to-one.
- [MTL4AlphaToOneState.enabled](https://developer.apple.com/documentation/metal/mtl4alphatoonestate/enabled) — Enables alpha-to-one.

### Initializers
- [init(rawValue:)](https://developer.apple.com/documentation/metal/mtl4alphatoonestate/init(rawvalue:))
