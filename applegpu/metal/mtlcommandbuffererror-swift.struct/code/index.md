...
<https://developer.apple.com/documentation/metal/mtlcommandbuffererror-swift.struct/code>
...
### Deprecated
- [MTLCommandBufferError.Code.blacklisted](https://developer.apple.com/documentation/metal/mtlcommandbuffererror-swift.struct/code/blacklisted) — A former error code that indicates the system has revoked the Metal device’s access because it’s responsible for too many timeouts or hangs.

### Initializers
- [init(rawValue:)](https://developer.apple.com/documentation/metal/mtlcommandbuffererror-swift.struct/code/init(rawvalue:))
