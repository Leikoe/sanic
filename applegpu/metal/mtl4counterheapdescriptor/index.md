...
<https://developer.apple.com/documentation/metal/mtl4counterheapdescriptor>
...
### Instance Properties
- [count](https://developer.apple.com/documentation/metal/mtl4counterheapdescriptor/count) — Assigns the number of entries in the heap.
- [type](https://developer.apple.com/documentation/metal/mtl4counterheapdescriptor/type) — Assigns the type of data that the heap contains.
