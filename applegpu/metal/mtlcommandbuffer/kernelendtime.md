...
You can calculate how much time the kernel spends scheduling a command buffer by subtracting [kernelStartTime](https://developer.apple.com/documentation/metal/mtlcommandbuffer/kernelstarttime) from this value.
