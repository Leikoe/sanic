...
<https://developer.apple.com/documentation/metal/mtlcommandbuffer/device>
...
The command buffer can only work with other instances that [device](https://developer.apple.com/documentation/metal/mtlcommandbuffer/device) creates, directly or indirectly, such as buffers and textures.
