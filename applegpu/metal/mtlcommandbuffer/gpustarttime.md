...
You can calculate how much time the GPU spends running a command buffer by subtracting this value from [gpuEndTime](https://developer.apple.com/documentation/metal/mtlcommandbuffer/gpuendtime). Both values are relative to system mach time.
