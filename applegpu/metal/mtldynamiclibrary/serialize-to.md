...
<https://developer.apple.com/documentation/metal/mtldynamiclibrary/serialize(to:)>
...
When the methods succeeds, the file contains a representation of the [MTLLibrary](https://developer.apple.com/documentation/metal/mtllibrary) from the [MTLDynamicLibrary](https://developer.apple.com/documentation/metal/mtldynamiclibrary) that creates it, as well as the binaries it has for the device your app is running on.
