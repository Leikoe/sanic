...
*Instance Property · iOS 8.0, iPadOS 8.0, Mac Catalyst 13.1, macOS 10.11, tvOS 9.0, visionOS 1.0*

<https://developer.apple.com/documentation/metal/mtltexture/usage>
...
You set this value in an [MTLTextureDescriptor](https://developer.apple.com/documentation/metal/mtltexturedescriptor) that you then use to create the given texture. After you create the texture, its usage options don’t change.
