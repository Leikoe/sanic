...
<https://developer.apple.com/documentation/metal/mtl4specializedfunctiondescriptor>
...
### Instance Properties
- [constantValues](https://developer.apple.com/documentation/metal/mtl4specializedfunctiondescriptor/constantvalues) — Configures optional function constant values to associate with the function.
- [functionDescriptor](https://developer.apple.com/documentation/metal/mtl4specializedfunctiondescriptor/functiondescriptor) — Provides a descriptor that corresponds to a base function that the specialization applies to.
- [specializedName](https://developer.apple.com/documentation/metal/mtl4specializedfunctiondescriptor/specializedname) — Assigns an optional name to the specialized function.
