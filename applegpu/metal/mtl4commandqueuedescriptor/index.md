...
<https://developer.apple.com/documentation/metal/mtl4commandqueuedescriptor>
...
### Instance Properties
- [feedbackQueue](https://developer.apple.com/documentation/metal/mtl4commandqueuedescriptor/feedbackqueue) — Assigns a dispatch queue to which Metal submits feedback notification blocks.
- [label](https://developer.apple.com/documentation/metal/mtl4commandqueuedescriptor/label) — Assigns an optional label to the command queue instance for debugging purposes.
