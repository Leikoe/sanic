...
![image](https://docs-assets.developer.apple.com/published/76256ecf7b056395a2c570d8dc8b2570/MTLFunctionStitchingGraph-1%402x.png)
...
- [init(functionName:nodes:outputNode:attributes:)](https://developer.apple.com/documentation/metal/mtlfunctionstitchinggraph/init(functionname:nodes:outputnode:attributes:)) — Creates a description of a new function call graph.
...
- [outputNode](https://developer.apple.com/documentation/metal/mtlfunctionstitchinggraph/outputnode) — The node with the output that’s the output of the new stitched function.
