...
<https://developer.apple.com/documentation/metal/mtlfunctionreflection>
...
### Instance Properties
- [bindings](https://developer.apple.com/documentation/metal/mtlfunctionreflection/bindings) — Provides a list of inputs and outputs of the function.
- [userAnnotation](https://developer.apple.com/documentation/metal/mtlfunctionreflection/userannotation) — The string passed to the user annotation attribute for this function. Null if no user annotation is present for this function.
