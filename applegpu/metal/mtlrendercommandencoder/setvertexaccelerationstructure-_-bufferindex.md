...
<https://developer.apple.com/documentation/metal/mtlrendercommandencoder/setvertexaccelerationstructure(_:bufferindex:)>
...
- **accelerationStructure** — An [MTLAccelerationStructure](https://developer.apple.com/documentation/metal/mtlaccelerationstructure) instance the command assigns to an entry in the vertex shader argument table for acceleration structures.
