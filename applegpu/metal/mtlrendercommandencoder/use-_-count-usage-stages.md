...
<https://developer.apple.com/documentation/metal/mtlrendercommandencoder/use(_:count:usage:stages:)>
...
- **resources** — A pointer to a C array of [MTLResource](https://developer.apple.com/documentation/metal/mtlresource) instances that subsequent draw commands depend on.
