...
<https://developer.apple.com/documentation/metal/mtlrendercommandencoder/setvertexintersectionfunctiontables(_:bufferrange:)>
...
- **functionTables** — An array of [MTLIntersectionFunctionTable](https://developer.apple.com/documentation/metal/mtlintersectionfunctiontable) instances the command assigns to entries in the vertex shader argument table for intersection function tables.
...
> **Note:**
>  The Objective-C version of this method is [setVertexIntersectionFunctionTables:withBufferRange:](https://developer.apple.com/documentation/metal/mtlrendercommandencoder/setvertexintersectionfunctiontables:withbufferrange:).
