...
<https://developer.apple.com/documentation/metal/mtltexturedescriptor/storagemode>
...
In iOS and tvOS, the default value is [MTLStorageMode.shared](https://developer.apple.com/documentation/metal/mtlstoragemode/shared). In macOS, the default value is [MTLStorageMode.managed](https://developer.apple.com/documentation/metal/mtlstoragemode/managed).
