...
<https://developer.apple.com/documentation/metal/mtl4commandallocatordescriptor>
...
### Instance Properties
- [label](https://developer.apple.com/documentation/metal/mtl4commandallocatordescriptor/label) — An optional label you can assign to the command allocator to aid debugging.
