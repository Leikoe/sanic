...
<https://developer.apple.com/documentation/metal/mtlstructmember/pointertype()>
...
An object that describes the pointer. If [dataType](https://developer.apple.com/documentation/metal/mtlstructmember/datatype) indicates that this member isn’t a pointer, this method returns `nil`.
