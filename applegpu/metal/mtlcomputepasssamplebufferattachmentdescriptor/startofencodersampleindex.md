...
This property indicates where the GPU stores the counter data within an [MTLCounterSampleBuffer](https://developer.apple.com/documentation/metal/mtlcountersamplebuffer) instance that it samples at the beginning of a compute pass.

You can tell the GPU to skip sampling at the start of the compute pass by assigning [MTLCounterDontSample](https://developer.apple.com/documentation/metal/mtlcounterdontsample) to this property.
