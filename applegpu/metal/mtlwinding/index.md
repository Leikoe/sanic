...
<https://developer.apple.com/documentation/metal/mtlwinding>
...
### Winding options
- [MTLWinding.clockwise](https://developer.apple.com/documentation/metal/mtlwinding/clockwise) — Primitives whose vertices are specified in clockwise order are front-facing.
- [MTLWinding.counterClockwise](https://developer.apple.com/documentation/metal/mtlwinding/counterclockwise) — Primitives whose vertices are specified in counter-clockwise order are front-facing.

### Initializers
- [init(rawValue:)](https://developer.apple.com/documentation/metal/mtlwinding/init(rawvalue:))
