...
<https://developer.apple.com/documentation/metal/mtl4counterheap>
...
### Instance Properties
- [count](https://developer.apple.com/documentation/metal/mtl4counterheap/count) — Queries the number of entries in the heap.
- [label](https://developer.apple.com/documentation/metal/mtl4counterheap/label) — Assigns a label for later inspection or visualization.
- [type](https://developer.apple.com/documentation/metal/mtl4counterheap/type) — Queries the type of the heap.

### Instance Methods
- [invalidateCounterRange(_:)](https://developer.apple.com/documentation/metal/mtl4counterheap/invalidatecounterrange(_:)) — Invalidates a range of entries in this counter heap.
- [resolveCounterRange(_:)](https://developer.apple.com/documentation/metal/mtl4counterheap/resolvecounterrange(_:)) — Resolves heap data on the CPU timeline.
