...
<https://developer.apple.com/documentation/metal/mtl4shaderreflection>
...
### Initializers
- [init(rawValue:)](https://developer.apple.com/documentation/metal/mtl4shaderreflection/init(rawvalue:))

### Type Properties
- [bindingInfo](https://developer.apple.com/documentation/metal/mtl4shaderreflection/bindinginfo) — Requests reflection information for bindings.
- [bufferTypeInfo](https://developer.apple.com/documentation/metal/mtl4shaderreflection/buffertypeinfo) — Requests reflection information for buffer types.
