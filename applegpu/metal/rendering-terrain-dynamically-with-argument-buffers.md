...
<https://developer.apple.com/documentation/metal/rendering-terrain-dynamically-with-argument-buffers>
...
![image](https://docs-assets.developer.apple.com/published/99d45f3f5b748f9b4ac9dfcc8e81e6ec/dynamic-terrain-with-argument-buffers-1-screenshot.png)

> **Note:**
> This sample reduces the overhead of encoding commands on the CPU by using argument buffers. For an introduction to argument buffers, see the samples listed in [Buffers](https://developer.apple.com/documentation/metal/buffers).
