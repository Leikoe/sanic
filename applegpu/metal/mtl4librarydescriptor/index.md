...
<https://developer.apple.com/documentation/metal/mtl4librarydescriptor>
...
### Instance Properties
- [name](https://developer.apple.com/documentation/metal/mtl4librarydescriptor/name) — Assigns an optional name to the Metal library.
- [options](https://developer.apple.com/documentation/metal/mtl4librarydescriptor/options) — Provides compile-time options for the Metal library.
- [source](https://developer.apple.com/documentation/metal/mtl4librarydescriptor/source) — Assigns an optional string containing the source code of the shader language program to compile into a Metal library.
