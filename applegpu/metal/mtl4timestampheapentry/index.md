...
<https://developer.apple.com/documentation/metal/mtl4timestampheapentry>
...
### Initializers
- [init()](https://developer.apple.com/documentation/metal/mtl4timestampheapentry/init())
- [init(timestamp:)](https://developer.apple.com/documentation/metal/mtl4timestampheapentry/init(timestamp:))

### Instance Properties
- [timestamp](https://developer.apple.com/documentation/metal/mtl4timestampheapentry/timestamp)
