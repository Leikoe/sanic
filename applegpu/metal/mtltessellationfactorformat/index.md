...
<https://developer.apple.com/documentation/metal/mtltessellationfactorformat>
...
### Factor formats
- [MTLTessellationFactorFormat.half](https://developer.apple.com/documentation/metal/mtltessellationfactorformat/half) — A 16-bit floating-point format.

### Initializers
- [init(rawValue:)](https://developer.apple.com/documentation/metal/mtltessellationfactorformat/init(rawvalue:))
