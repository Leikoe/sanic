...
<https://developer.apple.com/documentation/metal/mtlcomputepipelinestate/reflection>
...
The property is `nil` when you create a pipeline state from an[MTLDevice](https://developer.apple.com/documentation/metal/mtldevice) instance, such as with its [makeComputePipelineState(descriptor:options:completionHandler:)](https://developer.apple.com/documentation/metal/mtldevice/makecomputepipelinestate(descriptor:options:completionhandler:)) method.
