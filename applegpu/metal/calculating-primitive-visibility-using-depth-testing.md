...
<https://developer.apple.com/documentation/metal/calculating-primitive-visibility-using-depth-testing>
...
![image](https://docs-assets.developer.apple.com/published/2f36332e208881b306d2b8ecedbb62b8/1-depth-testing-flow.png)
...
![image](https://docs-assets.developer.apple.com/published/8ca4835838490529322cf97f7d5d91d6/2-depth-testing-pipeline.png)

### Configure the depth test

In Metal, you configure depth testing independently from the render pipeline, so you can mix and match combinations of render pipelines and depth tests. The depth test is represented by an [MTLDepthStencilState](https://developer.apple.com/documentation/metal/mtldepthstencilstate) object, and like you do with a render pipeline, you usually create this object when you initialize your app, and keep a reference to it as long as you need to execute that test.
...
![image](https://docs-assets.developer.apple.com/published/dd9e22ec0604186a9e16059b4b2d795a/3-depth-testing-depth-values.png)
