...
<https://developer.apple.com/documentation/metal/mtl4blendstate>
...
### Enumeration Cases
- [MTL4BlendState.disabled](https://developer.apple.com/documentation/metal/mtl4blendstate/disabled) — Disables blending.
- [MTL4BlendState.enabled](https://developer.apple.com/documentation/metal/mtl4blendstate/enabled) — Enables blending.
- [MTL4BlendState.unspecialized](https://developer.apple.com/documentation/metal/mtl4blendstate/unspecialized) — Defers determining the blending stage.

### Initializers
- [init(rawValue:)](https://developer.apple.com/documentation/metal/mtl4blendstate/init(rawvalue:))
