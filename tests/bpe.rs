...
fn matches_huggingface_on_a_gauntlet() {
    ...
    let cases: Vec<(&str, Vec<u32>)> = vec![
        ...
        (
            ...
            vec![220, 3756, 9029, 290, 220, 220, 4539, 197, 392, 198, 3605, 6615, 220, 220],
        ),
        (
            "unicode: héllo wörld — em—dash, 中文字, emoji 🎉!",
            vec![
                46903, 1098, 25, 289, 2634, 18798, 266, 30570, 335, 851, 795, 960, 42460, 11,
                220, 40792, 23877, 229, 27764, 245, 11, 44805, 12520, 236, 231, 0,
            ],
        ),
        (
        ...
        (
            ...
            vec![
                34, 17983, 20448, 17522, 62, 7442, 885, 65, 397, 12, 7442, 471, 10246, 1137,
                705, 421, 6421, 6,
            ],
        ),
