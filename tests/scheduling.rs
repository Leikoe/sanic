...
fn fused(dev: &DeviceSpecs, sq: f64, k: f64, d: f64) -> Option<(usize, Kernel)> {
...
fn cut(dev: &DeviceSpecs, sq: f64, k: f64, d: f64) -> Vec<Kernel> {
    let b = dev.dtype_bytes;
...
fn fuses(dev: &DeviceSpecs, sq: f64, k: f64, d: f64) -> bool {
